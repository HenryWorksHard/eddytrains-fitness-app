# EddyTrains Fitness App

A client-facing fitness application for **EddyTrains** coaching business. Provides workout programs, nutrition guidance, and progress tracking.
...
- Workout list with sets, reps, and weight recommendations
- Exercise tutorials with video embeds
- Nutrition calculator with macro breakdown
...
- [ ] Coach dashboard for program assignment
...
```bash
# Clone the repo
git clone https://github.com/HenryWorksHard/eddytrains-fitness-app.git
